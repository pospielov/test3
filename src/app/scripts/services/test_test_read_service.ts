/**
 * Module initializes rest service test_test_read_service
 */
import {
    Injectable
} from '@angular/core';
...
class test_test_read_service {
    ...
    execute(reqOpts?: any) {
         ...
         */
        let config = {
            url: "http://localhost/rest/1/db/collections/test/{_id}",
            method: "get",
            headers: this.entityAPI.removeUndefined(this.entityAPI.get("test_test_read_service.request.headers", reqOpts.headers, true)),
            params: this.entityAPI.removeUndefined(this.entityAPI.get("test_test_read_service.request.query", reqOpts.params, true)),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "test_test_read_service"
            }
        };
...
*/
export {
    test_test_read_service as ExportedClass
};